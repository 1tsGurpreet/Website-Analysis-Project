...
class Users {
  ...
  private function getAllPosts()
  {
    $query = "
      SELECT
          id, username, email, salt, hashSalt, rights
      FROM
          users;
    ";
  ...
  private function createPost()
  {
    ...
    $query = "
      INSERT INTO users
          (username, email, hashSalt, rights)
      VALUES
          (:username, :email, :hashSalt, :rights); //admin will put the password in hashSalt and we will hash it and create a salt for it
    ";
  ...
  private function updatePost($id)
  {
    ...
    $statement = "
      ...
      SET
        username = :username,
        email  = :email,
        hashSalt = :hashSalt, //if they update hash with salt
        rights = :rights
      WHERE id = :id;
    ";
  ...
  public function find($id) //I don't think we need this 
  {
    $query = "
      SELECT
          user, title, body, author, author_picture, created_at
      FROM
          post
      WHERE id = :id;
    ";
